...
const projectProp: ProjectProps = {
    ...
    teamSize: "13",
    contributions: ["Main Menu", "Progress Saving/Loading", "Animation Implementations"],
    ...
    description:
        (
            <div>
                ...
                These obstacles required players to carefully consider the movements of the frogs, in order to successfully navigate the level and keep the creature happy. <br /><br />
                <p className="font-bold text-2xl pb-2">Nominations & Awards</p>
                <ul className="list-inside list-disc">
                    <li><a className="text-blue-400 underline" href="https://www.gameawards.se/2022-nominees">Mobile Game of the Year and Best Art at the Swedish Game Awards 2022</a></li>
                    <li><a className="text-blue-400 underline" href="https://www.therookies.co/entries/16448">Mobile Game of the Year - People's Choice at The Rookies Awards 2022</a></li>
                </ul>
            </div>
        ),
