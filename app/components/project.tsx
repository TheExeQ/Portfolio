    ...
    <div className="w-full mt-auto">
      ...
      <div className="flex flex-col w-screen justify-center items-center">
        <div className="max-w-[1240px] w-full py-10 grid md:grid-cols-5 gap-8 border-t-2 border-gray-300">
          ...
          <div className="p-4 flex md:col-span-2 shadow-lg rounded-lg">
            <iframe
          ...
          {props.containers.map((container, index) => {
            return (
              <div
                ...
                className="p-4 w-full h-full md:col-span-2 shadow-lg rounded-lg"
              >
        ...
        >
          <div
            className="fixed p-6 top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-full md:w-[75%] 
                    bg-white/90 z-30 rounded-xl text-center max-h-[85vh] overflow-y-auto"
          >
            <h1 className="py-2">
              {props.containers[selectedImageIndex].title}
            </h1>
            <Image
              className="md:px-[15%] py-2"
              width={1920}
              height={1080}
              src={props.containers[selectedImageIndex].poster}
              alt=""
            />
            <p className="md:mx-auto md:max-w-[75%] pb-4 text-xl font-semibold">
              {props.containers[selectedImageIndex].desc}
            </p>
            <button
              className="px-6 py-3 font-bold rounded-2xl"
              onClick={toggleDetailedImage}
            >
              Close
            </button>
          </div>
