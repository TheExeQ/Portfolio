...
export default function Navbar(): JSX.Element {
  ...
  return (
    <div className="bg-[#ecf0f3] fixed left-0 top-0 w-full h-20 shadow-xl z-20">
      <div className="flex justify-between items-center w-full h-full px-8 2xl:px-16">
        ...
        <div>
          <ul className="hidden md:flex uppercase">
            <Link href="/">
              <li className="ml-10 text-sm border-b-2 border-transparent hover:border-[#F7AB0A]">
                Home
              </li>
            </Link>
            <Link href="/projects">
      ...
      >
        ...
        >
          ...
          <div className="py-4 flex flex-col">
            ...
            <div className="pt-40">
              <p className="uppercase tracking-widest text-[#F7AB0A]">
                Let's Connect
              </p>
